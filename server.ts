...
const forceSubCache = new Map<string, { isSubbed: boolean, timestamp: number }>();
const activeBots = new Map<string, Telegraf<Context>>();
...
const translations: any = {
    en: {
        welcome: "<tg-emoji emoji-id=\"5343603418527593251\">🚀</tg-emoji> <b>DASHBOARD CONTROL CENTER</b>\n━━━━━━━━━━━━━━━━━━━━\nWelcome to the specialized WhatsApp Account Warming system. Our automated engine keeps your devices active and safe by simulating natural human interactions.\n\n✨ <b>Key advantages:</b>\n• 🛡️ AI-Powered Anti-Ban Technology\n• 🔄 Automated 24/7 Messaging Loops\n• ⚡ Rapid Account Authority Growth\n• 🌍 International Reach Ready\n━━━━━━━━━━━━━━━━━━━━",
        choose_lang: "Select System Language:",
        main_menu: "Dashboard",
        add_acc: "Add Account",
        list_acc: "Account List",
        ...
        admin: "Admin Console",
        lang_btn: "Language Settings",
        clone_bot: "Clone System",
        clone_instruction: "Clone Bot\n\nPlease send your Bot API Token from @BotFather.\n\nNote: This bot will be a copy of this one and will run on our server.",
        force_sub: "⚠️ *Subscription Required:* Please join our channels to continue.",
        ...
        acc_deleted: "Account {phoneNumber} has been deleted and session cleared.",
        all_logged_out: "All accounts logged out and sessions cleared.",
        messaging_started: "Automated messaging started!\n\nCurrent Delay: {delay}s (+ random jitter)\nAnti-ban: Enabled (Typing simulation & randomized timing)",
        ...
        restore_warning_0_users: "Warning: The backup you uploaded contains 0 users. Restoring this will wipe your current data. If you are sure, please send the file again and confirm.",
        ...
        admin_redeploy_btn: "Redeploy/Restart",
        redeploy_instruction: "Redeploy Bot\n\nYou can trigger a redeploy of your bot. If a deploy hook is set (e.g., from Render), it will be triggered via POST request. Otherwise, the bot will perform a full restart.",
        redeploy_success: "Redeploy Triggered!\n\nThe bot services are being restarted. Please wait a few moments...",
        redeploy_hook_set: "Deploy Hook URL set to: `{url}`",
        joined_channels: "Welcome! You have successfully joined the required channels.",
        admin_restore_btn: "RESTORE DATABASE",
        admin_clones_btn: "Manage Clones",
    ...
    hi: {
        welcome: "🚀 *डैशबोर्ड कंट्रोल सेंटर*\n━━━━━━━━━━━━━━━━━━━━\nसबसे उन्नत व्हाट्सएप वॉर्मिंग सिस्टम में आपका स्वागत है। हमारा स्वचालित इंजन आपके खातों के बीच प्राकृतिक बातचीत को अनुकरण करके उन्हें सक्रिय और सुरक्षित रखता है।\n\n✨ *प्रमुख लाभ:*\n• 🛡️ AI-संचालित एंटी-बैन तकनीक\n• 🔄 स्वचालित 24/7 मैसेजिंग लूप\n• ⚡ तीव्र खाता अधिकार वृद्धि\n• 🌍 अंतर्राष्ट्रीय पहुंच तैयार\n━━━━━━━━━━━━━━━━━━━━",
        choose_lang: "🌐 भाषा चुनें:",
        main_menu: "🎮 कमांड डैशबोर्ड",
        add_acc: "✨ खाता जोड़ें",
        list_acc: "📑 खातों की सूची",
        start_msg: "🚀 बॉट शुरू करें",
        stop_msg: "⏹️ बॉट रोकें",
        schedule: "⏱️ शेड्यूल",
        delay: "⏲️ देरी सेट करें",
        status: "📈 सिस्टम स्थिति",
        referral: "💎 रेफरल प्रोग्राम",
        logout: "🚪 सभी लॉगआउट",
        admin: "🛡️ एडमिन कंसोल",
        lang_btn: "🌐 भाषा",
        clone_bot: "🧬 सिस्टम क्लोन करें",
        clone_instruction: "🤖 *बॉट क्लोन करें*\n\nकृपया @BotFather से अपना बॉट API टोकन भेजें।\n\n_नोट: यह बॉट इस बॉट की एक प्रति होगा और हमारे सर्वर पर चलेगा।_",
        ...
        min_delay: "⚠️ देरी बहुत कम है! सुरक्षा के लिए न्यूनतम 10 सेकंड।",
        ...
        access_expired: "⚠️ *एक्सेस समाप्त हो गया है।*",
    ...
    id: {
        welcome: "<tg-emoji emoji-id=\"5343603418527593251\">🚀</tg-emoji> <b>PUSAT KONTROL DASHBOARD</b>\n━━━━━━━━━━━━━━━━━━━━\nSelamat datang di sistem WhatsApp Warming tercanggih. Mesin otomatis kami menjaga akun Anda tetap aktif dan aman dengan mensimulasikan interaksi manusia yang alami.\n\n✨ <b>Keunggulan Utama:</b>\n• 🛡️ Teknologi Anti-Ban Berbasis AI\n• 🔄 Loop Pesan Otomatis 24/7\n• ⚡ Pertumbuhan Otoritas Akun Cepat\n• 🌍 Siap Jangkauan Internasional\n━━━━━━━━━━━━━━━━━━━━",
        choose_lang: "Pilih Bahasa Sistem:",
        main_menu: "Dashboard Perintah",
        add_acc: "Tambah Akun",
        list_acc: "Daftar Akun",
        start_msg: "Mulai Bot",
        stop_msg: "Hentikan Bot",
        schedule: "Jadwal",
        delay: "Atur Jeda",
        ...
        admin: "Konsol Admin",
        lang_btn: "Bahasa",
        clone_bot: "Klon Sistem",
        clone_instruction: "🤖 *Klon Bot*\n\nSilakan kirim Token API Bot Anda dari @BotFather.\n\n_Catatan: Bot ini akan menjadi salinan dari bot ini dan akan berjalan di server kami._",
        ...
        min_delay: "⚠️ Jeda terlalu singkat! Minimal 10 detik untuk keamanan.",
        ...
        manual_restore_started: "🛠️ *Memulai Pemulihan Manual...*",
        manual_restore_complete: "✅ *Pemulihan Selesai!*",
        manual_restore_failed: "❌ *Pemulihan Gagal:* {error}",
        admin_redeploy_btn: "🔄 Deploy Ulang/Restart",
        joined_channels: "👋 Selamat datang! Anda telah berhasil bergabung dengan saluran yang diperlukan.",
        admin_restore_btn: "🔴 PULIHKAN DATABASE",
        admin_clones_btn: "🤖 Kelola Klon",
        admin_panel_btn: "🛡️ Panel Admin",
        bot_status_title: "📲 *Status Bot Anda*",
        user_label: "👤 *Pengguna:*",
        bot_state_label: "⚙️ *Status Bot:*",
        access_label: "🔑 *Akses:*",
    ...
    zh: {
        welcome: "<tg-emoji emoji-id=\"5343603418527593251\">🚀</tg-emoji> <b>控制中心仪表板</b> \n━━━━━━━━━━━━━━━━━━━━\n欢迎使用最高级的 WhatsApp 账户养号系统。我们的自动化引擎通过模拟自然的人类交互，确保您的设备活跃且安全。\n\n✨ <b>核心优势：</b>\n• 🛡️ AI 驱动的反封号技术\n• 🔄 24/7 全天候自动消息循环\n• ⚡ 账号权重快速提升\n• 🌍 具备国际覆盖能力\n━━━━━━━━━━━━━━━━━━━━",
        choose_lang: "选择系统语言：",
        main_menu: "命令仪表板",
        add_acc: "添加账户",
        list_acc: "账户列表",
        ...
        lang_btn: "语言",
        clone_bot: "克隆系统",
        clone_instruction: "*克隆机器人*\n\n请发送来自 @BotFather 的机器人 API 令牌。\n\n_注意：此机器人将是此机器人的副本，并将在我们的服务器上运行。_",
        force_sub: "*请加入我们的频道以继续使用！*",
        verify_btn: "验证订阅",
        ...
        admin_redeploy_btn: "重新部署/重启",
        joined_channels: "欢迎！您已成功加入所需频道。",
        admin_restore_btn: "恢复数据库",
        admin_clones_btn: "管理克隆",
...
async function connectToWhatsApp(telegramId: string, phoneNumber: string, botInstance: Telegraf<Context>) {
    ...
    try {
        ...
        sock.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'close') {
                ...
                if (shouldReconnect) {
                    setTimeout(() => connectToWhatsApp(telegramId, phoneNumber, botInstance), 5000);
                } else {
                    // Permanent disconnect (Logout or Banned)
                    // Mark as disconnected but do NOT delete from database unless explicitly requested by user
                    // This allows them to see the account as "Disconnected" in their list.
                    await db.prepare("UPDATE whatsapp_sessions SET is_connected = 0 WHERE session_id = ?").run(sessionId);
                    ...
                    await botInstance.telegram.sendMessage(telegramId, t.acc_disconnected.replace('{phoneNumber}', phoneNumber), { parse_mode: 'Markdown' });
                }
                ...
                if (session && session.is_new_link === 1) {
                    await botInstance.telegram.sendMessage(telegramId, t.acc_connected.replace('{phoneNumber}', phoneNumber));
        ...
        if (!sock.authState.creds.registered && !pairingCodeRequested) {
            ...
            // Wait for a bit (shorter) to ensure socket is ready
            setTimeout(async () => {
                try {
                    ...
                    console.log(`[Session ${sessionId}] Pairing code received: ${code}`);

                    const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
                    const lang = user?.language || 'en';
                    const t = translations[lang] || translations.en;
                    
                    await botInstance.telegram.sendMessage(telegramId, 
                    ...
                    if (errorMsg.includes('rate-overlimit')) {
                        await botInstance.telegram.sendMessage(telegramId, t.rate_limit.replace('{phoneNumber}', phoneNumber));
                    } else {
                        await botInstance.telegram.sendMessage(telegramId, t.pairing_failed.replace('{phoneNumber}', phoneNumber).replace('{error}', errorMsg));
                    }
                }
 ...
 */
async function reconnectAllSessions(botInstance: Telegraf<Context>) {
    try {
        ...
        for (const session of sessionsInDb) {
            try {
                ...
                await connectToWhatsApp(session.telegram_id, session.phone_number, botInstance);
...
function setupBotHandlers(botInstance: Telegraf<Context>) {
...
botInstance.use(async (ctx, next) => {
    if (ctx.from) {
        ...
        // 1. Force Sub Check
        // Cache force sub check to improve responsiveness
        const subCacheKey = `sub_${telegramId}`;
        const now = Date.now();
        const cachedSub = forceSubCache.get(subCacheKey);
        
        if (!cachedSub || (now - cachedSub.timestamp > 1800000)) { // 30 mins cache
            const isSubbed = await checkForceSub(ctx, telegramId);
            forceSubCache.set(subCacheKey, { isSubbed, timestamp: now });
            if (!isSubbed) {
                const channels = await db.prepare("SELECT * FROM force_sub_channels").all() as any[];
                const buttons = [];
        ...
        } else if (!cachedSub.isSubbed) {
            // If cached as NOT subbed, check again to see if they joined
            const isSubbed = await checkForceSub(ctx, telegramId);
             forceSubCache.set(subCacheKey, { isSubbed, timestamp: now });
             if (!isSubbed) {
                // Return join message
                ...
                buttons.push([Markup.button.callback(t.verify_btn, 'verify_sub')]);
                return ctx.reply(t.force_sub, { parse_mode: 'Markdown', ...Markup.inlineKeyboard(buttons) });
             }
        }

        // 2. Language selection check (only if not already selecting language)
...
botInstance.action('change_language', (ctx) => {
    showLanguageSelection(ctx);
    ctx.answerCbQuery();
});

const getSuccessButton = (text: string, action: string, iconId: string = EMOJI.CHECK) => ({
    text: text,
...
const getDangerButton = (text: string, action: string, iconId: string = EMOJI.CROSS) => ({
    text: text,
    callback_data: action,
    style: "danger",
    icon_custom_emoji_id: iconId
...
const getSecondaryButton = (text: string, action: string, iconId: string = EMOJI.STATS) => ({
    text: text,
    callback_data: action,
    style: "primary",
    icon_custom_emoji_id: iconId
...
const getMainMenu = (telegramId: string, lang: string = 'en') => {
    const t = translations[lang] || translations.en;
    const buttons: any[] = [
        [getSuccessButton(t.add_acc || 'Add New Account', 'accounts_menu', EMOJI.PLUS)],
        [getSuccessButton(t.start_msg || 'Start Automation', 'automation_menu', EMOJI.ROCKET)],
        [
            getSecondaryButton(t.status || 'My Status', 'show_status', EMOJI.STATS),
            getSecondaryButton(t.referral || 'My Referrals', 'referral_program', EMOJI.DIAMOND)
        ],
        [getSecondaryButton(t.clone_bot || 'Clone This Bot', 'more_menu', EMOJI.ROBOT)],
    ];
    if (telegramId === OWNER_ID) {
        if (isFreshDb) {
            buttons.unshift([getDangerButton('RESTORE DATABASE', 'admin_restore_info', EMOJI.DIAMOND)]);
        }
        buttons.push([getDangerButton(t.admin || 'Admin Panel', 'admin_panel', EMOJI.SHIELD)]);
    }
    return Markup.inlineKeyboard(buttons);
};

const getAccountsMenu = (telegramId: string, lang: string = 'en') => {
    const t = translations[lang] || translations.en;
    return Markup.inlineKeyboard([
        [getSuccessButton(t.add_acc || 'Connect New No.', 'add_account', EMOJI.PLUS)],
        [getSecondaryButton(t.list_acc || 'Managed Accounts', 'list_accounts', EMOJI.STATS)],
        [getSecondaryButton(t.back_btn || 'Go Back', 'back_to_menu', EMOJI.BACK)]
    ]);
};

const getAutomationMenu = (telegramId: string, lang: string = 'en') => {
    const t = translations[lang] || translations.en;
    return Markup.inlineKeyboard([
        [getSuccessButton(t.start_msg || 'Launch Messages', 'start_messaging', EMOJI.ROCKET)],
        [getDangerButton(t.stop_msg || 'Halt Operations', 'stop_messaging', EMOJI.SHIELD)],
        [
            getSecondaryButton(t.schedule || 'Timeline', 'set_schedule', EMOJI.STATS),
            getSecondaryButton(t.delay || 'Delay Config', 'set_delay', EMOJI.STATS)
        ],
        [getSecondaryButton(t.back_btn || 'Go Back', 'back_to_menu', EMOJI.BACK)]
    ]);
};

const getMoreMenu = (telegramId: string, lang: string = 'en') => {
    const t = translations[lang] || translations.en;
    return Markup.inlineKeyboard([
        [getSecondaryButton(t.lang_btn || 'Set Language', 'change_language', EMOJI.GLOBE)],
        [getSecondaryButton(t.clone_bot || 'Deploy Clone', 'clone_bot_start', EMOJI.ROBOT)],
        [getDangerButton(t.logout || 'Logout All', 'logout_all', EMOJI.LOGOUT)],
        [getSecondaryButton(t.back_btn || 'Go Back', 'back_to_menu', EMOJI.BACK)]
    ]);
};
...
botInstance.start(async (ctx) => {
    ...
    ctx.reply(t.welcome, { parse_mode: 'HTML', ...getMainMenu(telegramId, lang) });
});
...
botInstance.command('accounts', async (ctx) => {
    const telegramId = ctx.from.id.toString();
    const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
    const lang = user?.language || 'en';
    const t = translations[lang] || translations.en;
...
botInstance.action('confirm_db_restore', async (ctx) => {
    try {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;
...
botInstance.action('cancel_restore', (ctx) => {
...
botInstance.action('admin_restore_info', (ctx) => {
    const adminId = ctx.from?.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.action('accounts_menu', async (ctx) => {
    const telegramId = ctx.from!.id.toString();
    const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
    const lang = user?.language || 'en';
    
    await ctx.editMessageText(`📱 *WhatsApp Device Manager*\n\nManage your connected accounts here. You can add new sessions or view existing ones to monitor their link status.`, {
        parse_mode: 'Markdown',
        ...getAccountsMenu(telegramId, lang)
    });
    ctx.answerCbQuery();
});

botInstance.action('automation_menu', async (ctx) => {
    const telegramId = ctx.from!.id.toString();
    const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
    const lang = user?.language || 'en';
    
    await ctx.editMessageText(`⚡ *Task & Interaction Hub*\n\nConfigure how your accounts behave. Setup custom delays, schedules, and start/stop the linking engine.`, {
        parse_mode: 'Markdown',
        ...getAutomationMenu(telegramId, lang)
    });
    ctx.answerCbQuery();
});

botInstance.action('more_menu', async (ctx) => {
    const telegramId = ctx.from!.id.toString();
    const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
    const lang = user?.language || 'en';
    
    await ctx.editMessageText(`🛠️ *Advanced Settings*\n\nAccess utility tools like language configuration, bot cloning, and session clear-up.`, {
        parse_mode: 'Markdown',
        ...getMoreMenu(telegramId, lang)
    });
    ctx.answerCbQuery();
});
...
botInstance.action('back_to_menu', async (ctx) => {
    ...
    const isRunning = user.is_running === 1 ? "Running" : "Stopped";

    const welcomeMsg = `🌟 *Premium Bot Dashboard*\n\n` +
                       `👤 *Account ID:* \`${telegramId}\`\n` +
                       `🤖 *Linking Engine:* ${isRunning}\n` +
                       `📱 *Active Devices:* \`${activeAccounts}/${accounts.length}\` Linked\n\n` +
                       `Navigate through the categories below to manage your system settings.`;

    if (ctx.callbackQuery) {
        await ctx.editMessageText(welcomeMsg, {
            parse_mode: 'Markdown',
            ...getMainMenu(telegramId, lang)
        });
    } else {
...
botInstance.action('show_status', (ctx) => {
    showStatus(ctx);
    ctx.answerCbQuery();
});
...
async function showStatus(ctx: Context) {
    ...
    if (!user) return ctx.reply("❌ Error: User not found in database.");
    ...
    let msg = `📊 *System Control Center*\n` +
              `━━━━━━━━━━━━━━━━━━━━\n` +
              `👤 *User:* \`${telegramId}\`\n` +
              `🤖 *System:* ${isRunning}\n` +
              `🔑 *Plan:* \`Premium\`\n\n` +
              `📈 *Activity Monitoring*\n` +
              `• Messages Processed: \`${user.sent_count || 0}\`\n` +
              `• Success Rate: \`100%\`\n\n` +
              `📱 *Device Management* (\`${activeAccounts}/${totalAccounts}\`)\n` +
              `━━━━━━━━━━━━━━━━━━━━\n`;

    if (accounts.length > 0) {
        accounts.forEach(acc => {
            const status = acc.is_connected === 1 ? "Linked" : "Offline";
            msg += `• \`${acc.phone_number}\` → ${status}\n`;
        });
    } else {
        msg += `_No devices connected. Go to WhatsApp Accounts to link one._`;
    }

    const keyboard = Markup.inlineKeyboard([
        [Markup.button.callback('Return to Dashboard', 'back_to_menu')]
    ]);
...
botInstance.action('show_referral', (ctx) => {
...
botInstance.action('claim_access', async (ctx) => {
    const telegramId = ctx.from!.id.toString();
    const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
    const lang = user?.language || 'en';
    const t = translations[lang] || translations.en;
...
botInstance.command('ping', (ctx) => ctx.reply('🏓 Pong! Bot is active and running.'));
botInstance.command('id', (ctx) => ctx.reply(`Your Telegram ID is: \`${ctx.from.id}\``, { parse_mode: 'Markdown' }));
...
botInstance.action('set_delay', async (ctx) => {
    const telegramId = ctx.from!.id.toString();
    const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
    const lang = user?.language || 'en';
    const t = translations[lang] || translations.en;
...
botInstance.on('text', async (ctx, next) => {
    ...
    // Check if it's a bot token (e.g. 123456789:ABCDEF...)
    if (/^\d+:[\w-]{35,}$/.test(text)) {
        const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
        const lang = user?.language || 'en';
        const t = translations[lang] || translations.en;
        ...
        try {
            ...
            await db.prepare("INSERT OR REPLACE INTO cloned_bots (token, owner_id) VALUES (?, ?)").run(text, telegramId);
            
            ctx.reply(`✅ *Bot Cloned Successfully!*\n\nBot: @${botInfo.username}\n\nYour bot is now running. You can manage it by sending /start to it.`, { parse_mode: 'Markdown' });
            
            // Start the cloned bot
            const clonedBot = new Telegraf<Context>(text);
            setupBotHandlers(clonedBot);
            clonedBot.launch().catch(err => console.error(`[Clone ${botInfo.username}] Launch error:`, err));
            activeBots.set(text, clonedBot);

        } catch (err: any) {
            console.error("Cloning Error:", err);
            ctx.reply(`❌ *Invalid Token*\n\nError: ${err.message || 'Could not verify token'}`);
        }
        return;
    }
    ...
    // Check if it's a phone number (10-16 digits, allowing +, spaces, dashes)
    const cleanedText = text.replace(/[\s\-\.\(\)]/g, '');
    if (/^(\+?\d{10,16})$/.test(cleanedText)) {
        const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
        const lang = user.language || 'en';
        const t = translations[lang] || translations.en;
        ...
        const phoneNumber = cleanedText;
        const cleanNumber = phoneNumber.replace(/\D/g, '');
        const sessionId = `session_${telegramId}_${cleanNumber}`;
        
        // Anti-hang: Close existing session if any
        const oldSock = sessions.get(sessionId);
        if (oldSock) {
            try {
                oldSock.ev.removeAllListeners('connection.update');
                oldSock.ev.removeAllListeners('creds.update');
                oldSock.end(new Error('Starting fresh pairing'));
            } catch (e) {}
            sessions.delete(sessionId);
        }

        // Delete existing auth data for fresh start
        await db.prepare("DELETE FROM whatsapp_auth WHERE session_id = ?").run(sessionId);
        ...
        if (!existing) {
            ...
            await db.prepare("UPDATE whatsapp_sessions SET phone_number = ?, is_new_link = 1 WHERE session_id = ?").run(phoneNumber, sessionId);
        }
        
        ctx.reply(t.pairing_fresh.replace('{phoneNumber}', phoneNumber));
        await connectToWhatsApp(telegramId, phoneNumber, botInstance);
        return;
    }
...
botInstance.action('list_accounts', async (ctx) => {
...
async function showAccountList(ctx: Context) {
    ...
    accounts.forEach((acc) => {
        const status = acc.is_connected ? 'Connected' : 'Disconnected';
        msg += `• \`${acc.phone_number}\` - ${status}\n`;
        buttons.push([Markup.button.callback('🔴 Delete ' + acc.phone_number, `delete_${acc.session_id}`)]);
    });
...
botInstance.action('start_messaging', async (ctx) => {
...
async function startMessaging(ctx: Context) {
    ...
    startMessagingLoop(telegramId, botInstance);
}

botInstance.action('stop_messaging', async (ctx) => {
...
botInstance.action('set_schedule', async (ctx) => {
    const telegramId = ctx.from!.id.toString();
    const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
    const lang = user?.language || 'en';
    const t = translations[lang] || translations.en;
...
botInstance.hears(/^(\d{1,2}:\d{2}-\d{1,2}:\d{2})$/, async (ctx) => {
...
botInstance.hears(/^access grant (\d+)(?:\s+(\d+))?$/, async (ctx) => {
    const adminId = ctx.from.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.hears(/^access remove (\d+)$/, async (ctx) => {
    ...
    botInstance.telegram.sendMessage(targetId, "🚫 Your access has been revoked by the admin.").catch(() => {});
});

botInstance.hears('access list', async (ctx) => {
    const adminId = ctx.from.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.hears(/^broadcast\s+(.+)$/s, async (ctx) => {
    const adminId = ctx.from.id.toString();
    if (adminId !== OWNER_ID) return;
    ...
    for (const u of users) {
        try {
            await botInstance.telegram.sendMessage(u.telegram_id, message, { parse_mode: 'Markdown' });
            success++;
        } catch (e) {
            fail++;
        }
...
botInstance.action(/^delete_(.+)$/, async (ctx) => {
...
botInstance.action('admin_stats', async (ctx) => {
    try {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;
...
botInstance.action('admin_users', async (ctx) => {
    try {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;
        ...
        for (const u of users) {
            ...
            if (u.telegram_id !== OWNER_ID) {
                const label = u.is_authorized ? `🔴 Revoke ${u.telegram_id}` : `🟢 Grant ${u.telegram_id}`;
                buttons.push([Markup.button.callback(label, `toggle_auth_${u.telegram_id}`)]);
            }
        }
...
botInstance.action(/^toggle_auth_(.+)$/, async (ctx) => {
    try {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;
...
botInstance.action('admin_backup', async (ctx) => {
    try {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;
...
botInstance.action('admin_restore', async (ctx) => {
    try {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;
...
botInstance.action('admin_redeploy', async (ctx) => {
    try {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;
        ...
        const hookSetting = await db.prepare("SELECT value FROM settings WHERE key = 'deploy_hook'").get() as any;
        const hookUrl = hookSetting?.value;
        ...
        const keyboard = Markup.inlineKeyboard([[Markup.button.callback('Back to Admin', 'admin_panel')]]);
        await ctx.editMessageText("✅ *Redeploy/Restart Triggered!*\n\nThe bot is performing a full restart of all sessions and services. You will receive a message once it's back online.", { parse_mode: 'Markdown', ...keyboard });
        
        // Perform a full restart of everything in-process
        console.log("[Redeploy] Manual restart triggered via admin panel.");
        
        // Give the user time to see the message before we restart
        setTimeout(async () => {
        ...
        ctx.reply(`❌ *Redeploy Failed:* ${err.message}`);
    }
});

botInstance.action('admin_panel', (ctx) => {
    try {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;
...
async function showAdminPanel(ctx: Context) {
    try {
        ...
        const keyboard = Markup.inlineKeyboard([
            [isBotActive ? getDangerButton('🛑 📴 Deactivate Bot', 'toggle_bot_active') : getSuccessButton('✅ 🔛 Activate Bot', 'toggle_bot_active')],
            [getSecondaryButton(isPublic ? '🔒 👤 Set PRIVATE' : '🌍 📢 Set PUBLIC', 'toggle_bot_mode')],
            [
                getSecondaryButton('📊 Bot Insights', 'admin_stats'),
                getSecondaryButton('✉️ Global Broadcast', 'admin_broadcast')
            ],
            [
                getSecondaryButton('🔐 Force Sub', 'admin_force_sub'),
                getSecondaryButton('📁 Database Backup', 'admin_backup')
            ],
            [
                getSecondaryButton('🔑 Session Restore', 'admin_restore'),
                getSecondaryButton('👥 Handle Clones', 'admin_clones')
            ],
            [
                getSecondaryButton('🚀 Hot Redeploy', 'admin_redeploy'),
                getSecondaryButton('🔗 Reveal App URL', 'admin_show_url')
            ],
            [
                getSecondaryButton('⚙️ User Control', 'admin_users'),
                getSecondaryButton('⬅️ Back to Menu', 'back_to_menu')
            ]
        ]);
    ...
    botInstance.action('admin_clones', async (ctx) => {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;

        const clones = await db.prepare("SELECT * FROM cloned_bots").all() as any[];
        let msg = "🤖 *Cloned Bots Management*\n\n";
        
        if (clones.length === 0) {
            msg += "No cloned bots found.";
        } else {
            for (const clone of clones) {
                msg += `• Token: \`${clone.token.substring(0, 10)}...\`\n  Owner: \`${clone.owner_id}\`\n  Active: ${clone.is_active ? '' : ''}\n\n`;
            }
        }

        const buttons = [];
        for (const clone of clones) {
            buttons.push([Markup.button.callback(`🗑️ Remove ${clone.token.substring(0, 5)}...`, `remove_clone_${clone.id}`)]);
        }
    ...
    botInstance.action(/^remove_clone_(\d+)$/, async (ctx) => {
        const adminId = ctx.from?.id.toString();
        if (adminId !== OWNER_ID) return;

        const cloneId = ctx.match[1];
        const clone = await db.prepare("SELECT * FROM cloned_bots WHERE id = ?").get(cloneId) as any;
        
        if (clone) {
            // Stop the bot if it's running
            const activeBot = activeBots.get(clone.token);
            if (activeBot) {
                try { activeBot.stop(); } catch (e) {}
                activeBots.delete(clone.token);
            }
            await db.prepare("DELETE FROM cloned_bots WHERE id = ?").run(cloneId);
            ctx.answerCbQuery("✅ Clone removed");
            // Refresh list
            const clones = await db.prepare("SELECT * FROM cloned_bots").all() as any[];
            let msg = "🤖 *Cloned Bots Management*\n\n";
            if (clones.length === 0) {
                ...
                for (const c of clones) {
                    msg += `• Token: \`${c.token.substring(0, 10)}...\`\n  Owner: \`${c.owner_id}\`\n  Active: ${c.is_active ? '' : ''}\n\n`;
                }
            }
            const buttons = [];
            for (const c of clones) {
                buttons.push([Markup.button.callback(`Remove ${c.token.substring(0, 5)}...`, `remove_clone_${c.id}`)]);
            }
            buttons.push([Markup.button.callback('Back to Admin', 'admin_panel')]);
            ctx.editMessageText(msg, { parse_mode: 'Markdown', ...Markup.inlineKeyboard(buttons) });
        } else {
            ctx.answerCbQuery("❌ Clone not found");
        }
    });

botInstance.action('admin_show_url', (ctx) => {
    const adminId = ctx.from?.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.action('toggle_bot_active', async (ctx) => {
    const adminId = ctx.from!.id.toString();
    if (adminId !== OWNER_ID) return;
    ...
    const broadcastStatus = async () => {
        for (const u of users) {
            try {
                await botInstance.telegram.sendMessage(u.telegram_id, msg, { parse_mode: 'Markdown' });
...
botInstance.action('toggle_bot_mode', async (ctx) => {
    const adminId = ctx.from!.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.action('admin_broadcast', (ctx) => {
    const keyboard = Markup.inlineKeyboard([[Markup.button.callback('Back to Admin', 'admin_panel')]]);
...
botInstance.action('admin_force_sub', (ctx) => {
...
botInstance.hears(/^add channel\s+(-?\d+)$/i, async (ctx) => {
    const adminId = ctx.from.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.hears(/^del channel\s+(-?\d+)$/i, async (ctx) => {
    const adminId = ctx.from.id.toString();
    if (adminId !== OWNER_ID) return;
...
// --- Bot Mode Commands ---
botInstance.hears(/^\/restore$/i, async (ctx) => {
    const adminId = ctx.from!.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.hears(/^set url\s+(https?:\/\/.+)$/i, async (ctx) => {
    const adminId = ctx.from!.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.hears(/^bot mode (public|private)$/i, async (ctx) => {
    const adminId = ctx.from.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.hears(/^set hook\s+(https?:\/\/.+)$/i, async (ctx) => {
    const adminId = ctx.from!.id.toString();
    if (adminId !== OWNER_ID) return;

    const url = ctx.match[1];
    await db.prepare("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?)").run('deploy_hook', url);
    ctx.reply(`✅ *Deploy Hook URL Updated*\n\nURL: \`${url}\`\n\nClicking 'Redeploy' in Admin Panel will now trigger a POST request to this URL.`, { parse_mode: 'Markdown' });
});

// --- Force Sub Channel Commands ---
botInstance.hears(/^channel add (-?\d+)$/, async (ctx) => {
    const adminId = ctx.from.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.hears(/^channel remove (-?\d+)$/, async (ctx) => {
    const adminId = ctx.from.id.toString();
    if (adminId !== OWNER_ID) return;
...
botInstance.action('verify_sub', async (ctx) => {
    try {
        const telegramId = ctx.from?.id.toString();
        ...
        if (isSubbed) {
            ...
            // Re-use back_to_menu logic for consistency
            const accounts = await db.prepare("SELECT * FROM whatsapp_sessions WHERE telegram_id = ?").all(telegramId) as any[];
            const activeAccounts = accounts.filter(acc => acc.is_connected === 1).length;
            const isRunning = user.is_running === 1 ? "Running" : "Stopped";

            const welcomeMsg = `🌟 *Premium WhatsApp Linker*\n\n` +
                               `👤 *User:* \`${telegramId}\`\n` +
                               `🤖 *Bot State:* ${isRunning}\n` +
                               `📱 *Connected:* \`${activeAccounts}/${accounts.length}\` Accounts\n\n` +
                               `Use the buttons below to manage your system.`;

            return ctx.reply(welcomeMsg, { parse_mode: 'Markdown', ...getMainMenu(telegramId, lang) });
        } else {
...
botInstance.action('logout_all', async (ctx) => {
    const telegramId = ctx.from!.id.toString();
    const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId) as any;
    const lang = user?.language || 'en';
    const t = translations[lang] || translations.en;
...
async function stopAllSessions() {
    console.log("[Shutdown] Stopping all WhatsApp sessions and messaging loops...");
    for (const [sessionId, sock] of sessions.entries()) {
        try {
            // Remove listeners to avoid reconnection loops during shutdown
            sock.ev.removeAllListeners('connection.update');
    ...
    sessions.clear();
    // Stop all active messaging timeouts
...
async function sendBetweenAccounts(sender: any, receiver: any, telegramId: string, step: number, user: any, botInstance: Telegraf<Context>) {
...
async function startMessagingLoop(telegramId: string, botInstance: Telegraf<Context>) {
    ...
    if (!isManual && !isScheduledActive) {
        if (schedule) {
            ...
            const timeout = setTimeout(() => startMessagingLoop(telegramId, botInstance), 300000);
    ...
    const results = await Promise.all(pairs.map(p => sendBetweenAccounts(p.sender, p.receiver, telegramId, step, user, botInstance)));
    ...
    const nextTimeout = setTimeout(() => startMessagingLoop(telegramId, botInstance), finalDelay);
    ...
    for (const sched of activeSchedules) {
        ...
        if (isWithinTimeRange(sched.cron_time, user?.language)) {
            ...
            if (!activeTimeouts.has(sched.telegram_id)) {
                ...
                startMessagingLoop(sched.telegram_id, bot);
            }
        }
    }
});
...
async function startServer() {
    ...
    app.get("/api/status", async (req, res) => {
        try {
            const users = await db.prepare("SELECT COUNT(*) as count FROM users").get() as any || { count: 0 };
            const sessions = await db.prepare("SELECT COUNT(*) as count FROM whatsapp_sessions").get() as any || { count: 0 };
            const connected = await db.prepare("SELECT COUNT(*) as count FROM whatsapp_sessions WHERE is_connected = 1").get() as any || { count: 0 };
    ...
    app.get("/api/health", (req, res) => {
        res.json({ 
            ...
            database: db ? "initialized" : "missing"
        });
    });
    ...
    app.post("/api/action", express.json(), async (req, res) => {
        ...
        try {
            const user = await db.prepare("SELECT * FROM users WHERE telegram_id = ?").get(telegramId.toString()) as any;
            if (!user) return res.status(404).json({ error: "User not found" });

            const lang = user.language || 'en';
            const t = translations[lang] || translations.en;

            // Trigger corresponding bot action
            // This is a bit tricky since we need a context-like object or just call the logic
            // For now, we'll respond and maybe send a message to the user
            
            let responseMsg = "";
            switch (action.toLowerCase()) {
                case 'start':
                    await db.prepare("UPDATE users SET is_running = 1 WHERE telegram_id = ?").run(telegramId.toString());
                    responseMsg = t.messaging_started.replace('{delay}', user.delay_seconds || 250);
                    break;
                case 'stop':
                    await db.prepare("UPDATE users SET is_running = 0 WHERE telegram_id = ?").run(telegramId.toString());
                    responseMsg = t.messaging_stopped;
                    break;
                case 'logout':
                    // Just an example, real logout needs more logic
                    responseMsg = "Initiating logout for all sessions...";
                    break;
                case 'refresh':
                    responseMsg = "Dashboard stats refreshed.";
                    break;
                default:
                    responseMsg = `Action ${action} received.`;
            }

            if (responseMsg) {
                await bot.telegram.sendMessage(telegramId, responseMsg, { parse_mode: 'Markdown' });
            }
    ...
    app.listen(Number(PORT), "0.0.0.0", async () => {
        ...
        // Start cloned bots
        try {
            const clones = await db.prepare("SELECT * FROM cloned_bots WHERE is_active = 1").all() as any[];
            console.log(`[Startup] Starting ${clones.length} cloned bots...`);
            for (const clone of clones) {
                try {
                    const clonedBot = new Telegraf<Context>(clone.token);
                    setupBotHandlers(clonedBot);
                    clonedBot.launch().catch(err => console.error(`[Clone ${clone.token.substring(0, 5)}] Launch error:`, err));
                    activeBots.set(clone.token, clonedBot);
                } catch (err) {
                    console.error(`[Startup] Failed to start cloned bot ${clone.token.substring(0, 5)}:`, err);
                }
            }
        } catch (err) {
            console.error("[Startup] Error loading cloned bots:", err);
        }
    });
}
...
-Alive] Self-ping failed:`, err.message);
    }
});
